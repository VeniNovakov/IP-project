...
__decorate([
    (0, typeorm_1.Column)({ nullable: false, type: 'varchar', default: 'error' }),
...
__decorate([
    (0, typeorm_1.Column)({ nullable: true, type: 'varchar', default: 'error' }),
    __metadata("design:type", String)
], User.prototype, "refresh_token", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => documents_entity_1.Document, (document) => document.owner),
